## AND Gate Verification Project
A SystemVerilog verification environment for a basic 2-input AND gate, implemented and simulated on **EDA Playground** using **Aldec Riviera Pro**.
...
## 📁 Project Structure
- `rtl.sv`: The RTL code for the AND gate.
...
To the design a deliberate bug (OR logic instead of AND) can be added to demonstrate the power of **SystemVerilog Assertions**. You will see assertion failures in the log indicating mismatches.
